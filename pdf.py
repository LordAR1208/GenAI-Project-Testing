...
def get_conversational_chain():
    prompt_template="""
Ansewr the question as detailed as possible from the provided context, make sure to provide all the details, if the answer is not in
...
def user_input(user_question):
    ...
    output_text = response.get('text', 'No response received.')
    print(output_text)
